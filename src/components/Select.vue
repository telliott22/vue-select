    ...
    getOptionLabelSplit: {
      ...
      default(option) {
        ...
        if (typeof option === "object") {
          ...
          return option[this.label] && option[this.label].split(",").length
            ? option[this.label].split(",")[0]
            : option[this.label];
        }
        return option.split(",").length ? option.split(",")[0] : option;
      }
    },
